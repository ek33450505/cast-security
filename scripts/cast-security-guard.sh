...
mkdir -p "${HOME}/.claude/cast-security/hook-last-fired"
touch "${HOME}/.claude/cast-security/hook-last-fired/cast-security-guard.timestamp"
...
msg = '[CAST-SECURITY] Sensitive operation detected: {}. Consider reviewing this change before committing. Run: cast-security audit'.format(reason)
